---
name: RAS-TestCaseReview
description: Human-in-the-loop TC Review & Enhancement System
---

# 🚨 [최최선 명령] - TC v1 수신 시 3 초 안에 수행
...
**AI 는 반드시 `render_phase1_markdown()` 함수를 사용하여 출력을 생성해야 합니다.**
...
```markdown
## [Phase 1] Evidence Collection 완료
...
| 증거 ID | 출처 | 관련 내용 | 신뢰도 |
|---------|------|-----------|--------|
| EVD-001 | {source} | {content} | Strong |

---

### 🔍 {fr_id} 요구사항 매핑

| 요구사항 | TC 반영 여부 | 검증 Step |
|---------|--------------|-----------|
| {req_1} | ✅/❌/⚠️ | {step} |
...
### ⏸️ 다음 단계 (Phase 2: Review Queue 생성)

1. **CHG-001 (P1)**: {내용}
2. **CHG-002 (P2)**: {내용}

**Phase 2 Review Queue 를 생성하시겠습니까?** (예/아니오)
```
...
**버전**: 6.0 (2026-07-28, Block 체크리스트 추가, 300 행 압축)
